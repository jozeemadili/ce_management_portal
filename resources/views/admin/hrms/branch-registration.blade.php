						...
						<table class="table table-xs">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href=""><small>{{strtoupper($user->branch_name)}}</small></a></td>
                                    <td><a href=""><small>{{strtoupper($user->branch_id)}}</small></a></td>
                                    <td>{{$user->status}}</td>
                                    <td>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{ old('branch_name') }}" required  name="branch_name">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" >Branch ID</label>
                                <input class="form-control" type="text" value="{{ old('branch_id') }}" required  name="branch_id">
                            </div>
                        </div>
                    </div>
