                    ...
                    <p>
                      <div class="table-responsive">
						...
						<table class="table table-xs">
							...
							<tbody>
                                @foreach($Directorate as $user)
								<tr>
									<th scope="row">{{$loop->index + 1}}.</th>
									<td><a href=""><small>{{strtoupper($user->dname)}}</small></a></td>
									<td>{{$user->htitle}}</td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ Route('add-directorates') }}">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="col-form-label" >Directorate Name</label>
                                <input class="form-control" type="text" value="{{ old('dname') }}" required  name="dname">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" >Head Of Directorate Tittle</label>
