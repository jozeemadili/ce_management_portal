						...
						<table class="table table-xs">
							<thead>
								<tr>
                                    ...
                                    <th scope="col">Directorate</th>
                                      <th scope="col">Head Of Directorate Tittlec</th>
                                    <th scope="col">phyiscal Addres</th>
							...
							<tbody>
								...
								<tr>
									...
									<td><a href=""><small>{{strtoupper($user->sname)}}</small></a></td>
                                    <td><a href=""><small>{{strtoupper($user->Directorate->dname)}}</small></a></td>
									<td>{{$user->htitle}}</td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title">Directorate Registration</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{ old('dname') }}" required  name="dname">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" >Head Of Section Tittle</label>
                                <input class="form-control" type="text" value="{{ old('htitle') }}" required  name="htitle">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" >Physical Address</label>
                                <input class="form-control" type="text" value="{{ old('address_details') }}" required  name="address_details">
                            </div>
                            <div class="form-group">
                            <label class="col-form-label" >Select Directorate</label>
                                <select class="form-select" required name="directorate">
                                <option value="">--- Choose Directorate ---</option>  
                                        @foreach ($Directorate as $branch)
                                    <option value='{{strtoupper($branch->id)}}'>{{strtoupper($branch->dname)}}</option>
                                    @endforeach
								</select>
                            </div>
                        </div>
