 ...
 <div class="modal fade" id="newModal" tabindex="-1" aria-hidden="true" style="display: none;">
    ...
    <form method="post" action="{{ Route('add-product') }}">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input class="form-control" readonly type="text" required name="unit_of_measure" value="Hours">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group">
                    <input class="form-control" type="text" readonly required name="service_type" value="SERVICE">
                </div>
            </div>
        </div>
