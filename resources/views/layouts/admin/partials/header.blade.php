<div class="page-main-header">
  <div class="main-header-right row m-0">
    <div class="main-header-left">
      <div class="logo-wrapper"><a href="{{ route('home') }}"><img class="img-fluid" src="{{asset('assets/images/logo/psp.png')}}" alt=""></a></div>
      <div class="dark-logo-wrapper"><a href="{{ route('home') }}"><img class="img-fluid" src="{{asset('assets/images/logo/pp.png')}}" alt=""></a></div>
      ...
      <ul>
        <li>
          <div class="form-inline search-form">
            <div class="search-bg">
            @if(Auth::user()->role == 'Insurer Admin' || Auth::user()->role == 'Insurer Staff' || Auth::user()->role == 'Agent Admin' || Auth::user()->role == 'Agent Staff' || Auth::user()->role == 'Broker Admin' || Auth::user()->role == 'Broker Staff' || Auth::user()->role == 'Bank Assurance Admin' || Auth::user()->role == 'Bank Assurance Staff')
