<div>
    ...
    <div class="alert alert-info d-flex align-items-center gap-2">
        ...
        <div>
            ...
            <small>Cells created here will automatically belong to your church</small>
        </div>
    </div>

    <div class="row">
        <div class="col-md-6 mb-3">
            <label class="form-label">Cell Group Name</label>
    ...
    <hr class="my-3">
    <p class="modal-section-label"><i class="icofont icofont-users"></i> Cell Members</p>
    ...
    <div class="row g-2 align-items-center mb-2">
        ...
        <div class="col-md-4">
            <select class="form-control" wire:model="members.{{ $index }}.role">
                ...
                <option value="ASSISTANT_CELL_LEADER">Assistant Cell Leader</option>
                <option value="CELL_MEMBER">Cell Member</option>
            </select>
        </div>
    ...
    <button type="button" class="btn btn-primary" wire:click="save">
        <i class="icofont icofont-check-circled"></i> Save Cell Group
    </button>
