        ...
        <li>
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{ route('churches-export') }}"><i class="icofont icofont-file-excel"></i> Export as Excel</a></li>
                </ul>
            </div>
        </li>
        <li>
            <a class="btn btn-primary" href="{{ route('churches-management') }}">
                <i class="icofont icofont-listing-box"></i> Manage Churches
            </a>
        </li>
    @endslot

    <li class="breadcrumb-item"><a href="{{ route('churches-management') }}">Church</a></li>
...
<div class="print-only">
    <h3>Church Hierarchy</h3>
    <p class="text-muted">Generated {{ now()->format('d M Y, H:i') }}</p>
</div>
...
<div class="tree-stat-row no-print">
    <div class="tree-stat">
        ...
        <div>
            <p class="tree-stat-value">{{ $stats['total'] }}</p>
    ...
    <div class="tree-stat">
        ...
        <div>
            <p class="tree-stat-value">{{ $stats['with_head'] }}</p>
    ...
    <div class="tree-stat">
        ...
        <div>
            <p class="tree-stat-value">{{ $stats['without_head'] }}</p>
...
<div class="org-chart-scroll">
    <ul class="org-tree" id="org-tree">
        @forelse($roots as $root)
            @include('portal.churches.partials.tree-node', ['church' => $root, 'byParent' => $byParent, 'designationColors' => $designationColors])
        @empty
