{{-- Shared styles for the Programs & Attendance module - same visual
     language established across every other module this session (Church,
     Member, Cell, Department, Pledges). --}}
<style>
    .prog-stat-card {
